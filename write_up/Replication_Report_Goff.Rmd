...
#there are 7 t.test one for each age group. Aggregate first. 
#each t test compares exactly two groups. a main t.test compares the two conditions, black and white
# use the formula argument for the t. test 
# forumala is lh to rh where lh is the value and rh is the groups. 
# the agemean that participants give depends on which condition they give 
