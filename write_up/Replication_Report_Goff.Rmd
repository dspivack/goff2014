...
This replication, differs in that it uses MTurk participants. It is also only testing two of the conditions, white and black.  
...
This replication will use MTurk paricipants instead of university students. I am unsure as to whether this will have a large effect on the results. Additionally, I am only comparing the black and white conditions, and have omitted the neutral condition. Lastly, we did not  power the analysis to correct for multiple comparisons. If the aggregate is not significant we will consider the main effect to not have replicated. 
...
#### Actual Sample
  The sample will be 50 MTurk particpants who are from the USA and have over an 80% approval rating. 
